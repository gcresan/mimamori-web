...
$current_plan_label = $tier_labels[ $current_tier ] ?? '見える化プラン';
                ...
                <div class="inq-group">
                    ...
                    <div class="inq-type-list" id="inqTypeList">
                        ...
                        <label class="inq-type-item">
                            ...
                            <span class="inq-type-box"><span class="inq-type-radio"></span>改善代行プランに変更したい</span>
                        </label>
                        <label class="inq-type-item">
                ...
                <div class="inq-conditional" id="condPlanChange">
                    ...
                    <div class="inq-group">
                        ...
                        <select id="inqDesiredPlan" name="desired_plan" class="inq-select">
                            ...
                            <option value="見える化プラン"<?php echo $initial_plan === '見える化プラン' ? ' selected' : ''; ?>>見える化プラン</option>
                            <option value="改善提案プラン"<?php echo $initial_plan === '改善提案プラン' ? ' selected' : ''; ?>>改善提案プラン</option>
                            <option value="改善代行プラン"<?php echo $initial_plan === '改善代行プラン' ? ' selected' : ''; ?>>改善代行プラン</option>
                        </select>
                    </div>
                </div>
