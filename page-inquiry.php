                ...
                <div class="inq-group">
                    ...
                    <div class="inq-type-list" id="inqTypeList">
                        ...
                        <label class="inq-type-item">
                            ...
                            <span class="inq-type-box"><span class="inq-type-radio"></span>MEO・口コミ対策プランに変更したい</span>
                        </label>
                        <label class="inq-type-item">
                        ...
                        <label class="inq-type-item">
                            ...
                            <span class="inq-type-box"><span class="inq-type-radio"></span>プロ伴走・改善実行プランに変更したい</span>
                        </label>
                        <label class="inq-type-item">
                ...
                <div class="inq-conditional" id="condPlanChange">
                    ...
                    <div class="inq-group">
                        ...
                        <select id="inqDesiredPlan" name="desired_plan" class="inq-select">
                            ...
                            <option value="MEO・口コミ対策プラン"<?php echo $initial_plan === 'MEO・口コミ対策プラン' ? ' selected' : ''; ?>>MEO・口コミ対策プラン</option>
