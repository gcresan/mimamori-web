...
```json
{
  "summary": "総合評価の本文。現状の総評・主な強み・改善が必要な点を含む200〜300文字程度の文章。",
...
## summary（総評）の書き方
summary は **200〜300文字程度** の文章にし、(1)総合スコアを踏まえた全体の総評、(2)主な強み、(3)改善が必要な点、を簡潔にまとめてください。冗長にならないようにしつつ、経営者が現状を把握できる内容にすること。
