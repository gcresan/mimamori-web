...
class Mimamori_Bot_Installer {
	...
	public static function install(): void {
		...
		$sql_tenants = "CREATE TABLE " . self::table_tenants() . " (
			...
			fab_rounded TINYINT(1) NOT NULL DEFAULT 1,
			fab_shadow TINYINT(1) NOT NULL DEFAULT 1,
			fab_size SMALLINT NOT NULL DEFAULT 56,
			fab_size_md SMALLINT NULL,
			fab_width_pct_sp SMALLINT NULL,
