...
$tier_name     = $tier_defs_all[ $service_tier ]['name'] ?? 'AI改善提案プラン';
...
.contract-badge--test     { color: #d97706; background: rgba(217,119,6,0.08); }
...
<div class="acct-container">
    ...
    <!-- 通知設定は「各種設定 › 通知設定」(page-notifications.php) に集約 -->
