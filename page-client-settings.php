...
.area-type-option.selected { border-color: #528C5A; background: #f0fdf4; }
.area-type-option input[type="radio"] { margin-top: 2px; accent-color: #528C5A; }
...
.area-sub-field textarea:focus {
    outline: none; border-color: #528C5A; box-shadow: 0 0 0 3px rgba(82,140,90,.12);
}
...
.subcategory-grid .subcategory-item.checked {
    border-color: #528C5A; background: #f0fdf4; color: #166534;
}
.subcategory-grid .subcategory-item input[type="checkbox"] {
    accent-color: #528C5A; width: 14px; height: 14px; margin: 0;
}
...
.btype-option.selected { border-color: #528C5A; background: #f0fdf4; color: #166534; }
.btype-option input[type="radio"] { accent-color: #528C5A; }

/* 保存ボタン */
.cs-actions { margin-top: 24px; display: flex; gap: 12px; }
.cs-actions .btn-save {
    padding: 10px 32px; background: #528C5A; color: #fff; border: none;
...
.persona-grid .subcategory-item.checked { border-color: #528C5A; background: #f0fdf4; color: #166534; }
.persona-grid .subcategory-item input[type="checkbox"] { accent-color: #528C5A; width: 14px; height: 14px; margin: 0; }
...
.ref-url-row input:focus { outline: none; border-color: #528C5A; box-shadow: 0 0 0 3px rgba(82,140,90,.12); }
.ref-url-remove {
...
.btn-add-ref-url:hover { border-color: #528C5A; color: #528C5A; }

/* AI生成ボタン */
.btn-generate-persona {
    display: inline-flex; align-items: center; gap: 6px;
    padding: 8px 18px; border: 1px solid #528C5A; border-radius: 8px;
...
.btn-persona-gen {
    padding: 9px 20px; background: #528C5A; color: #fff; border: none;
    border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer;
...
.btn-apply-overwrite { background: #528C5A; color: #fff; border: none; }
.btn-apply-overwrite:hover { background: #2d6b54; }
.btn-apply-append { background: #fff; color: #528C5A; border: 1px solid #528C5A; }
